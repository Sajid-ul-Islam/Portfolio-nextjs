...
// import ExtensionsPanel from "./panels/ExtensionsPanel"; // Removed
...
type SidebarProps = {
  isOpen?: boolean;
  onClose?: () => void;
  activePanel?: "explorer" | "search" | "git" | "account" | "settings" | "terminal" | "chat"; // Removed 'extensions'
...
// case "extensions":
//   return <ExtensionsPanel />; // Removed
      case "account":
        return <AccountPanel />;
      case "settings":
