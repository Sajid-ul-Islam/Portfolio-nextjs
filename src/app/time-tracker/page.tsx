...
export default function TimeTrackerPage() {
    return (
        <main className="min-h-screen bg-zinc-50 dark:bg-black text-zinc-900 dark:text-zinc-100">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-28 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        ...
                        <div className="bg-orange-500/10 border border-orange-500/20 p-6 rounded-2xl hover:bg-orange-500/20 transition-colors duration-300">
