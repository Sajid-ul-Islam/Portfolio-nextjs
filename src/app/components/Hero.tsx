      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 items-center gap-10">
          ...
          <div className="flex flex-col items-center order-1 lg:order-2">
            <div className="relative w-48 h-48 sm:w-[220px] sm:h-[220px] md:w-[280px] md:h-[280px] rounded-full p-1 border-2 border-[#a3e635]/30 shadow-[0_0_50px_rgba(163,230,53,0.15)] group">
            ...
            <h1 className="mt-4 sm:mt-8 text-3xl sm:text-5xl font-black text-white tracking-tighter uppercase glow-text">
              <GlitchText text={personalInfo.name} delay={500} speed={40} />
            </h1>
            ...
            <div className="mt-4 sm:mt-8 flex flex-col items-center gap-4 sm:gap-6">
              ...
              {/* Broadcast Interface */}
              <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-6 border-t border-[#a3e635]/10 w-full justify-center group/broadcast">
